			...
			<div className="container mb-2">
				<div className="row">
					...
					<div className="mt-5 mb-2 col-sm-12 col-md-6">
						...
						<div className="pl-4 pr-4 mt-3 mb-0 d-flex justify-content-start align-items-center">
							<p className="pl-4 pr-4 mt-2 mb-2 text-start">
              ...
              <li className={`${styles.list} text-gray`}>
                My dinning table in a seashore
					...
					<div className="mt-3 mb-3 col-sm-12 col-md-6">
						<div className="row">
							<div className="col-lg-6 col-md-4 col-sm-4">
								{!imageForEnlargeViewMode &&
									...
									imageResponse.generated_images.length && (
										<p className="mb-3 text-gray">Click on images to enlarge</p>
									)}
								{imageForEnlargeViewMode && (
							...
							{imageForEnlargeViewMode && (
								<div className="mb-3 col-lg-6 col-md-8 col-sm-8 d-flex justify-content-between">
						...
						{!imageForEnlargeViewMode ? (
							<div className="pt-2 mt-4 row">
								{loading &&
									[1, 2, 3, 4].map((i) => (
										<div
											className={`col-6 col-sm-12 col-md-6 mb-3 mt-1`}
											key={i}
										>
